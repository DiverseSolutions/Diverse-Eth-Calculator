...
export default function CheckAddress(){
  ...
  function handleClipboard(){
    navigator.clipboard.writeText(addressInput.toString())

    callAlert('Success','success','Successfully copied amount to clipboard')
  }
  ...
  function handleCheckAddress(){
    if(ethers.utils.isAddress(addressInput)){
      callAlert('Success','success','Correct Address')
    }else{
      callAlert('Error','error','Incorrect Address')
    }
  }
      ...
      <div className="mockup-phone">
        ...
        <div className="display">
          <div className="p-5 artboard artboard-demo phone-1">
            ...
            <h1 className="text-xl">Check Address</h1>
            ...
            <div className="w-full form-control">
              ...
              <label className="input-group">
                ...
                <input 
                  ...
                  value={addressInput}
                  placeholder="0xb83E7D21cd4c2f162692bbf2C94f864FEE488965"
                  className="w-full appearance-none focus:outline-none input input-bordered"
                />
            ...
            <button onClick={handleCheckAddress} className="mt-5 border cursor-pointer btn-wide btn">
              Check Address
            </button>
  ...
  function callAlert(title,icon,content){
      Swal.fire({
        title: title,
        text: content,
        icon: icon,
