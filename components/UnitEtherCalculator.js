...
export default function UnitEtherCalculator(){
  ...
  useEffect(() => {
    ...
    if( amount == '' || unit == '' || amount[0] == '0' || unit[0] == '0' || isNaN(parseFloat(amount)) || isNaN(parseFloat(unit)) ){
      setResult('')
      return;
    }    

    let amountBN = ethers.utils.parseUnits(amount.toString(),parseInt(unit))
    setResult(amountBN.toString())
      ...
      <div className="mockup-phone">
        ...
        <div className="display">
          <div className="p-5 artboard artboard-demo phone-1">
            ...
            <div className="w-full mt-10 form-control">
              <label className="label">
